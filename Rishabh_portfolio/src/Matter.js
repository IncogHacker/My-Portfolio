{/* Written in jquery is used to write js code  in shorter way  <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
...
// ✅ Scroll fix: allow mouse wheel scroll even over the canvas
m.render.canvas.addEventListener('wheel', function (e) {
  e.preventDefault();
  window.scrollBy({
    top: e.deltaY,
    behavior: 'smooth'
